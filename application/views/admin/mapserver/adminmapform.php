...
?><form method="post" action="<?=base_url().$ctrlpath.$action?>">
    ...
    <fieldset>
        ...
        <div class="accordion">
            <label>Fontset file&nbsp;
                <a class="linkexplorer" title="Explorador" href="<?=base_url().$dataexplorerctrlpath?>?return=msmapfontset"><img src="<?=base_url()?>web/images/icons/png/16x16/search.png" alt="explorador" title="Explorador" /></a>
            </label>
            <input id="msmapfontset" type="text" name="fontset" value="<?=$msmapfile->fontset?>" />
            
            <label>Symbolset file&nbsp;
                <a class="linkexplorer" title="Explorador" href="<?=base_url().$dataexplorerctrlpath?>?return=msmapsymbolset"><img src="<?=base_url()?>web/images/icons/png/16x16/search.png" alt="explorador" title="Explorador" /></a>
            </label>
